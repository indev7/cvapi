...
export async function POST(request: NextRequest) {
  try {
    ...
    const ranking = await prisma.cvRanking.create({ data: {
      ...
      education_evidence: parsed.education_evidence ?? null,
      work_experience_score: parsed.work_experience_score ?? 0,
      work_experience_evidence: parsed.work_experience_evidence ?? null,
      skill_match_score: parsed.skill_match_score ?? 0,
      skill_match_evidence: parsed.skill_match_evidence ?? null,
      certifications_score: parsed.certifications_score ?? 0,
      certifications_evidence: parsed.certifications_evidence ?? null,
      domain_knowledge_score: parsed.domain_knowledge_score ?? 0,
      domain_knowledge_evidence: parsed.domain_knowledge_evidence ?? null,
      soft_skills_score: parsed.soft_skills_score ?? 0,
      soft_skills_evidence: parsed.soft_skills_evidence ?? null,
      total_score: total,
